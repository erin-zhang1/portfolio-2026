  ...
  return (
    ...
    >
      <div className="mx-auto flex max-w-[980px] flex-col items-center space-y-4 text-center">
        ...
        >
          Technical achievements in automation, testing, and delivery
        </AnimatedText>
      </div>

      <div className="mx-auto grid w-full max-w-[1440px] gap-5 xl:grid-cols-[1.25fr_1fr]">
      ...
      <div className="mx-auto grid w-full max-w-[1440px] grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4">
        {impactMetrics.slice(2).map((metric) => (
          <MetricCard key={metric.label} metric={metric} />
        ))}
      </div>
    </AnimatedSection>
